...
class OK {
  ...
  factory OK.fromJson(String source) =>
      OK.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'OK(name: $name)';
  ...
  bool operator ==(Object other) {
    ...
    return other is OK && listEquals(other.name, name);
  }
